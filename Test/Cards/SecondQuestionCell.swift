...
class SecondQuestionCell: UITableViewCell {

    let bgView: UIImageView = {
        let v = UIImageView()
        v.image = R.image.backView2()
        return v
    }()
    ...
    let aLabel: UILabel = {
        ...
        l.text = "when my dad took me oh his job ‍🔬"
        l.textColor = .white
        l.numberOfLines = 0
        return l
    }()
